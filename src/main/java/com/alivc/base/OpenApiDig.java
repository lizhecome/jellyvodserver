 ...
 */
/** 
 * ClassName: OpenApiDig <br/> 
 * Function: TODO OpenApiDig util. <br/> 
 * Reason:   TODO OpenApiDig. <br/> 
 * Date:     2019年3月16日  <br/> 
 * @author   tz 
 * @version   v0.0.1
 * @since    JDK 1.8 
...
public class OpenApiDig {
	 ...
	 * @return
	 */
	public static String[] getResultData(String url,Map<String, String> params){
		...
		String[] result = doRequst(httpClient, null, url, params, publicKey);
		return result;
	}
