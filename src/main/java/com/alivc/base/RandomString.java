...
public class RandomString {
    ...
    public static final String SOURCES_NUMBER =
            "1234567890";
    public static final String SOURCES_AKS =
            "ABCDEFGHIJKLMNOPQRSTYVWXYZabcdefghijklmnopqrstuvwxyz1234567890-";
    public static final String SOURCES_ST =
    		"ABCDEFGHIJKLMNOPQRSTYVWXYZabcdefghijklmnopqrstuvwxyz1234567890-/=+";
    ...
    public static String getData() { 
   	  ...
   	  for (int i = 0; i < digit; i++) { 
   		...
   		// 0-9的随机数
   		str += x.toString();
   		// 拼成10位数 因为int类型只能存放200000000+的数据，所以只能用字符串拼接 
   		} 
